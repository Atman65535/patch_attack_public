...
import os
cwd = os.getcwd()
patch_path = os.path.join(cwd, "src/patch/patch.pat") # 暂为了存储patch的pickle，但是还没写存储的功能
...
paths = dict(
    ...
    model_pretrained = "/home/atman/a_workspace/mmlab/mmsegmentation/src/configs/pretrained/UNet++_rellis_50e_512x512.pth"
)
dataset_cfg = dict(
